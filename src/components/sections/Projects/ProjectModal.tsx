  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      <div className="space-y-6">
        {/* Header Image */}
        <div className="relative h-64 -m-6 mb-6 bg-surface overflow-hidden">
          <img
            src={project.image}
            alt={project.title}
        ...
        {/* Technologies */}
        <div>
          <h3 className="font-semibold text-lg text-foreground mb-3">Technologies utilisées</h3>
          <div className="space-y-3">
            {project.technologies.frontend.length > 0 && (
              <div>
                <p className="text-sm font-medium text-muted mb-2">Frontend</p>
            ...
            {project.technologies.backend.length > 0 && (
              <div>
                <p className="text-sm font-medium text-muted mb-2">Backend</p>
                <div className="flex flex-wrap gap-2">
            ...
            {project.technologies.tools.length > 0 && (
              <div>
                <p className="text-sm font-medium text-muted mb-2">Outils</p>
                <div className="flex flex-wrap gap-2">
        ...
        {project.features.length > 0 && (
          <div>
            <h3 className="font-semibold text-lg text-foreground mb-3">Fonctionnalités principales</h3>
